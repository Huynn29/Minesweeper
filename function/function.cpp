...
bool loadmedia()
{
	...
	{
		cout << "Can't load this image from file!" << endl;
		success = false;
	}
	else
	{
	...
	if (!menu.loadFromRenderedText("PLAY", textcolor1))
	{
		cout << "Fail" << endl;
	}
	...
	if (!menuColor.loadFromRenderedText("PLAY", color))
	{
		cout << "Fail" << endl;
		success = false;
	}
...
bool loadMenuMedia()
{
	...
	if (!menuTheme.loadFromFile("res/images/menu (1).jpg"))
	{
		cout << "Fail" << endl;
		success = false;
	}
	...
	SDL_Color textColor = { 180,255,255 };
